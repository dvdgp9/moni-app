    ...
    <div class="container">
      ...
      <nav class="nav">
        ...
        <?php if (!empty($_SESSION['user_id'])): ?>
          ...
          <a href="/?page=settings" title="Ajustes" aria-label="Ajustes">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="vertical-align:middle">
          ...
          <a href="/?page=profile" style="margin-left:auto" title="Perfil" aria-label="Perfil">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="vertical-align:middle">
